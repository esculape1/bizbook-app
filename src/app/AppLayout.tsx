...
export function AppLayout({ 
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
            ...
            <Sheet open={isSheetOpen} onOpenChange={setSheetOpen}>
              ...
              <SheetContent side="left" className="flex flex-col w-[300px]">
                ...
                <div className="mt-auto pt-6 border-t">
                   <footer className="text-center text-[10px] text-muted-foreground/60 uppercase tracking-widest font-bold">
                      <p>© {new Date().getFullYear()} BizBook</p>
      ...
      {/* Desktop Footer (Optional, very slim) */}
      <footer className="hidden xl:block py-6 border-t bg-card/30 mt-auto">
        <div className="max-w-[1800px] mx-auto px-8 flex justify-between items-center text-[10px] text-muted-foreground/60 uppercase tracking-widest font-bold">
          <p>© {new Date().getFullYear()} BizBook - Pilotage d'entreprise</p>
          <p>Développé par DLG Caverne Consortium</p>
        </div>
      </footer>
    </div>
  );
