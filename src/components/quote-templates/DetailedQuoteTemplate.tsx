          ...
          <div key={pageIndex} className="p-4 flex flex-col min-h-[29.7cm]" style={{ fontSize: '12pt', pageBreakAfter: isLastPage ? 'auto' : 'always' }}>
            ...
            <header className="flex justify-between items-start mb-2">
              ...
              <div className="w-1/2 text-right">
                <h1 className="text-lg font-bold text-gray-900" style={{ fontSize: '16pt' }}>FACTURE PROFORMA</h1>
                <p className="mt-1 text-sm">{quote.quoteNumber}</p>
              ...
              <footer className="mt-auto pt-2">
                <div className="flex justify-between items-start mt-1">
                  <div className="w-2/3 pt-1">
                      <p className="font-bold text-gray-700 text-xs">Arrêtée la présente facture proforma à la somme de :</p>
