...
export function AppLayout({ children, user }: { children: ReactNode, user: User }) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col">
      <header className="sticky top-0 flex h-16 items-center justify-between border-b bg-background px-4 md:px-6 z-40">
        {/* Left Group: Mobile Menu Trigger and Desktop Logo */}
